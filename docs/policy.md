...
their API domains must be added — however, note that some proxies (Pipelock
with TLS interception, for example) will interfere with the traffic if the
requests are sent as generic proxy traffic.
